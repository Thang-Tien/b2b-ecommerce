          ...
          <div>
            ...
            {active === 2 && (
              <div className="flex justify-between">
                ...
                <div className="w-3/4 mr-5 grid grid-cols-1 mb-12 ">
                  {supplier && supplier.filter(supplier => supplier.type === "Supplier").map((i, index) => <Card data={i} key={index} />)}
            ...
            {active === 3 && (
              <div className="flex justify-between">
                ...
                <div className="w-3/4 mr-5 grid grid-cols-1 mb-12">
                {supplier && supplier.filter(supplier => supplier.type === "Manufacturer").map((i, index) => <Card data={i} key={index} />)}
                </div>
                {supplier && supplier.length === 0 ? (
                  <h1 className="text-center w-full pb-[100px] text-[20px]">
